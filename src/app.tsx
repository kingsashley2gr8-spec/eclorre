...
function NavLogo({ scrolled }: { scrolled: boolean }) {
    return (
        <img src={LOGO_URL} alt="Eclorre" style={{
            height: "52px", width: "auto", objectFit: "contain",
            filter: scrolled ? "brightness(0.15) sepia(1) saturate(3) hue-rotate(5deg)" : "brightness(10) saturate(0)",
    ...
    return (
      ...
      `}</style>
            ...
            <nav style={{
                ...
                background: navSolid ? "rgba(248,245,240,0.97)" : "transparent",
                backdropFilter: navSolid ? "blur(14px)" : "none",
                borderBottom: navSolid ? "1px solid #e8e0d4" : "1px solid transparent",
            ...
            <section style={{ minHeight: "100vh", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", zIndex: 3, display: "flex", flexDirection: "column", justifyContent: "center", padding: "140px 52px 120px", maxWidth: "600px", minHeight: "100vh" }}>
                    ...
                    <div className={visible ? "fu3" : ""} style={{ marginBottom: "28px", maxWidth: "380px" }}>
                        <p style={{ fontFamily: "'Jost',sans-serif", fontSize: "14px", fontWeight: "300", lineHeight: 1.8, color: "rgba(240,228,200,0.75)", letterSpacing: "0.03em" }}>
                            One destination. Every African fashion brand, designer, and creative house worth knowing — discovered, verified, and indexed for a global audience.
                        </p>
                    </div>
            ...
            <div style={{ background: "#F8F5F0", padding: "56px 52px" }}>
                <div style={{ maxWidth: "1080px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "1px", background: "#e0d8cc" }}>
                    {[
                        { icon: "◈", title: "Verified Listings", desc: "Every brand is reviewed and approved by our editorial team — no noise, no algorithms." },
                        { icon: "◇", title: "Editorial Depth", desc: "Rich profiles on every listing — brand story, aesthetic direction, collections, and stockists." },
                        { icon: "◉", title: "54 Countries Covered", desc: "From Lagos to Nairobi, Dakar to Cape Town — the most comprehensive index of African fashion." },
                        { icon: "◎", title: "Built for Discovery", desc: "Search by country, category, aesthetic, or price point. The right brand, found instantly." },
                    ].map(f => (
            ...
            <div style={{ background: "#1a1610", padding: "14px 0", overflow: "hidden" }}>
                <div className="marquee-wrap">
                    {[...DESIGNERS, ...DESIGNERS].map((d, i) => (
                        <span key={i} style={{ fontFamily: "'Jost',sans-serif", fontSize: "8px", letterSpacing: "0.45em", color: "#4a4030", textTransform: "uppercase", padding: "0 28px", whiteSpace: "nowrap" }}>
                            {d} <span style={{ color: "#c8a84e", opacity: 0.4 }}>◈</span>
                        </span>
                    ))}
                </div>
            </div>
            ...
            <section style={{ padding: "110px 52px", maxWidth: "1080px", margin: "0 auto" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
                    <div>
                        ...
                        <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(28px,4vw,50px)", fontWeight: "300", lineHeight: 1.3, color: "#1a1610", marginBottom: "28px" }}>
                            The definitive index<br /><em style={{ color: "#c8a84e" }}>of African fashion.</em>
                        </h2>
                        <p style={{ fontFamily: "'Jost',sans-serif", fontSize: "13px", lineHeight: 1.9, color: "#7a6a50", fontWeight: "300", marginBottom: "18px" }}>
                            Eclorre is the world's most comprehensive fashion directory dedicated to African and diaspora brands. Think of it as the Vogue index meets the global African fashion scene.
                        </p>
                        <p style={{ fontFamily: "'Jost',sans-serif", fontSize: "13px", lineHeight: 1.9, color: "#7a6a50", fontWeight: "300" }}>
                            Whether you're a fashion lover, a buyer sourcing for a retailer, or press researching a story — Eclorre is your single source of truth.
                        </p>
                    </div>
            ...
            <section style={{ padding: "0 52px 110px", maxWidth: "1080px", margin: "0 auto" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(210px,1fr))", gap: "40px" }}>
                    {[
                        { num: "01", title: "Brand Index", desc: "Hundreds of verified African fashion brands — searchable, filterable, and always up to date." },
                        { num: "02", title: "Deep Editorial Profiles", desc: "Every listing includes brand story, creative direction, collections, and where to shop." },
                        { num: "03", title: "Discover by Region", desc: "Browse by country, city, category, or aesthetic. Filter to exactly what you're looking for." },
                        { num: "04", title: "Trend Reports", desc: "Quarterly reports from our on-the-ground editors — what's emerging and who's rising." },
                    ].map(f => (
